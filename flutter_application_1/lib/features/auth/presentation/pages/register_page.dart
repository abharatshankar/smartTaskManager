...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> _submit() async {
    ...
    await context.read<AuthCubit>().register(_usernameCtrl.text.trim(), _emailCtrl.text.trim(), _passwordCtrl.text);
  }
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                width: 56,
                                height: 56,
                                decoration: BoxDecoration(color: const Color(0xFFF0EAFF), borderRadius: BorderRadius.circular(18)),
                                child: const Icon(Icons.person_add_alt_1_rounded, color: Color(0xFF7C3AED)),
                              ),
                              const SizedBox(height: 18),
                              const Text('Create Account', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800)),
                              const SizedBox(height: 6),
                              Text('Register to manage your tasks securely.', style: TextStyle(color: Colors.grey.shade600)),
